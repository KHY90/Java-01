...
public class Application01 {
    ...
    public static void main(String[] args){
        ...
        *  클래스 또한 부뫀늘래스와 자식클래스로 역할을 나누어서 부모가 가지는 멤버를 자식이 물려받아
        *  자신의 멤버인 것 처럼 사용할 수 있돌고 만든 기술이다.
        *
        ...
        * */
        ...
        racingCar.stop();
        racingCar.soundHorn();
//        racingCar.sprayWater(); // 형제의 기능은 사용불가
