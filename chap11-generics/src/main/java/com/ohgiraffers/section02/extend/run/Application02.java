...
//        Anytype 의 조건은 없다. 하지만 RabbitFarm의 조건은 <T extends Rabbit>으로 RabbitFarm을 생성할 수 없다는 문제가 있다.
...
//        그래서 아래와 같이 RabbitFarm의 생성 조건을 만족한다면 anyType의 조건을 만족하게 되는 것이다.
        ...
        wildCardFarm.anyType(new RabbitFarm<DrungkenBunny>(new DrungkenBunny()));
...
//        wildCardFarm.extendsType(new RabbitFarm<Rabbit>(new Rabbit()));
        ...
        wildCardFarm.extendsType(new RabbitFarm<DrungkenBunny>(new DrungkenBunny()));
...
//        wildCardFarm.superType(new RabbitFarm<DrungkenBunny>(new DrungkenBunny()));
