...
public class Application03 {
    ...
    public static void main(String[] args){
        ...
        * 실무적으로는 굉장히 중요하기 때문에 반드시 숙히해야 하고,
        ...
        *   2-1. 변수명의 길이는 제한이 없다.
        *           int gjdfklasjgiorewjkgblfdajklgbjfdkla;
        *   2-2. 변수명의 합성어로 이루어진 첫 단어에는 소문자, 두번째 시작 단어는 대문자로 시작한다.(camel-case)
        *           int maxNum;
        *   2-3. 단어와 단어 사이의 연결을 언더스코어로 하지 않는다.
        *           int max_num;
        *   2-4. 한글로 변수명을 짓 는 것이 가능하지만, 권장하지 않는다.
        *           int 숫자;
        ...
        */
        ...
        System.out.println("이름은 " + name + "이고 " + "나이는 " + age + "세 입니다. 그리고 " + gender + "입니다.");
